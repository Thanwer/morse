...
class UpdateDialog extends React.Component {
	...
	render() {
		...
		var dialogId = "updateMessage-" + this.props.message.entity._links.self.href;
...
class Message extends React.Component {
	...
	render() {
		return (
			<tr>
				<td>{this.props.message.entity.author}</td>
				<td>{this.props.message.entity.createDate}</td>
				<td>{this.props.message.entity.text}</td>
				<td>
